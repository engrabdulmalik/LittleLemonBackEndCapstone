...
class MenuViewTest(TestCase):
    ...
    def setUp(self):
        ...
        Menu.objects.create(title="44 oz Tomahawk Steak",
                            price=121.00, inventory=10)
        Menu.objects.create(title="16 oz Ribeye Steak",
                            price=22.00, inventory=10)
        Menu.objects.create(title="12 oz NY Prime Steak",
                            price=18.00, inventory=10)
